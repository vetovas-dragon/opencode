      ...
      <el-menu :default-active="$route.path" router class="side-menu">
        ...
        <el-menu-item index="/student/chat">
          <el-badge :value="unread" :hidden="!unread" class="menu-badge">
            <el-icon><ChatDotRound /></el-icon><span>在线问诊</span>
          </el-badge>
        </el-menu-item>
        <el-menu-item index="/student/plans">
          <el-icon><Tickets /></el-icon><span>实训计划</span>
        </el-menu-item>
        <el-menu-item index="/student/summaries">
          <el-icon><EditPen /></el-icon><span>问诊总结</span>
        </el-menu-item>
        <el-menu-item index="/student/records">
          <el-icon><Timer /></el-icon><span>实训记录</span>
        </el-menu-item>
      </el-menu>
    </el-aside>
    <el-container>
      <el-header class="header">
        ...
        <div class="user-box">
          ...
          <el-tag size="small" type="primary" effect="plain">医学生</el-tag>
...
import { HomeFilled, ChatDotRound, Tickets, EditPen, Timer } from '@element-plus/icons-vue'
...
const avatarChar = computed(() => (userStore.name || '生').slice(0, 1))
...
const pageName = computed(() => {
  const map: Record<string, string> = {
    ...
    '/student/chat': '在线问诊',
    '/student/plans': '实训计划',
    '/student/summaries': '问诊总结',
    '/student/records': '实训记录',
  }
  return map[router.currentRoute.value.path] || '医学生端'
})
